...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 17, 'title' => 'controle_do_ponto_access',],
            ['id' => 18, 'title' => 'controle_do_ponto_create',],
            ['id' => 19, 'title' => 'controle_do_ponto_edit',],
            ['id' => 20, 'title' => 'controle_do_ponto_view',],
            ['id' => 21, 'title' => 'controle_do_ponto_delete',],
