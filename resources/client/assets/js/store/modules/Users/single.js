...
const actions = {
    ...
    setAlmoco({ commit }, value) {
        commit('setAlmoco', value)
    },
    setCargahoraria({ commit }, value) {
        commit('setCargahoraria', value)
    },
    resetState({ commit }) {
        commit('resetState')
    }
...
const mutations = {
    ...
    setAlmoco(state, value) {
        state.item.almoco = value
    },
    setCargahoraria(state, value) {
        state.item.cargahoraria = value
    },
