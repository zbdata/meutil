    ...
    data() {
        return {
            columns: [
                ...
                { title: 'Função', field: 'role', tdComp: DatatableList },
                { title: 'Matricula', field: 'matricula', sortable: true },
                { title: 'Almoço', field: 'almoco', sortable: true },
                { title: 'Carga Horária', field: 'cargahoraria', sortable: true },
